...
import { AgentModelName, AgentThinkingLevel } from '../models'
...
export interface AgentRequest {
	...
	/**
	 * The model-specific reasoning effort selected for this request.
	 */
	...
	/**
	 * When true, the user asked for an HTML preview box in this request.
	 */
